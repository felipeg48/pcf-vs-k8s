...
[source,shell]
----
kubectl create -f directory-rest-pod.yaml
----

5. Expose the *directory-rest* as a Service:
+
.directory-rest-service.yaml
[source,yaml]
----
kind: Service
apiVersion: v1
...
[source,shell]
----
kubectl create -f directory-rest-service.yaml
----
...
[source,shell]
----
kubectl create -f directory-ui-pod.yaml
----
